      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{
            ...
            No worries! We'll send you a reset link to get back in the game.
          </p>
        </div>
        ...
        <div style={{ textAlign: 'center' }}>
          <Link to="/login" style={{
            ...
            <span role="img" aria-label="back">←</span> Back to Login
          </Link>
        </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            <span role="img" aria-label="tip">💡</span> Can't find the email? Check your spam folder!
          </p>
        </div>
      </div>
